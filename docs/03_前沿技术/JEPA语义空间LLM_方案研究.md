...
> **设计原则**：① 吸收现有方案的实证结论；② 避开 §4 的四个难点；③ 与主人项目（BioBrain）及"矩阵流"设想对接
...
>
> **⇒ 两者可以共用同一个语义空间**
> **BioBrain 的"群组 KV 缓存"正好对应 LCM 的 concept 序列**
...
| 与 BioBrain 的接口 | ❌ **纯构想**（"矩阵流 = 概念序列"这个判断**未验证**） |
